...
const generateProjects = projectsArr => {
	...
	const projectHtmlArr = featuredProjects.map(({ name, description, languages, link }) => {
		return `
...
module.exports = templateData => {
	// destructure projects and about data from templateData base on their property key names
